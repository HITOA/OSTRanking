CREATE TABLE IF NOT EXISTS users(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name NVARCHAR(32) NOT NULL, password_hash VARCHAR(60) NOT NULL, email VARCHAR(320) NOT NULL, creation_date DATETIME NOT NULL);
CREATE TABLE IF NOT EXISTS admins(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, FOREIGN KEY (user_id) REFERENCES users(id));
...
CREATE TABLE IF NOT EXISTS osts(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name NVARCHAR(256) NOT NULL, url VARCHAR(256) NOT NULL, length SMALLINT NOT NULL, short_length SMALLINT, alternate_name NVARCHAR(256), published_date DATE NOT NULL);
